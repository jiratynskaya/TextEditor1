...
namespace TextEditor1
{
    class MainPresenter
    {
        private readonly IMainForm1 _view;
        private readonly IFileManager1 _manager;
        private readonly IMessageService _messageService;

        private string _currentFilePath;

        public MainPresenter(IMainForm1 view, IFileManager1 manager, IMessageService service)
        {
            _view = view;
            _manager = manager;
